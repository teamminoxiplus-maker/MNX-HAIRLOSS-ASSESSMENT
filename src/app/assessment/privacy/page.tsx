  ...
  return (
    <MinoxShell>
      <article className="space-y-4 text-sm leading-relaxed text-slate-300">
        <h1 className="text-xl font-extrabold text-white">Privacy Notice</h1>
        <p>
        ...
        <h2 className="pt-2 text-base font-bold text-white">Retention</h2>
        <p>
        ...
        <p>
          ...
          <a href={`mailto:${CONSULT.email}`} className="text-emerald-400 underline">
            {CONSULT.email}
          </a>
          .
        </p>
